                ...
                <div class="row">
                 <!-- <h3 class="head">Books</h3> -->
                    <div class="col-md-3 pt-4 book-1 ">
                        <img src="/img/School-Books/1.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 book-2">
                        <img src="/img/School-Books/2.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 book-3 py=5px">
                        <img src="/img/School-Books/3.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 book-4">
                        <img src="/img/School-Books/4.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 mb-4 book-5 ">
                        <img src="/img/School-Books/5.jpg"  class="img-fluid" >
                    </div>
                    <div class="col-md-3 pt-4 book-6">
                        <img src="/img/School-Books/6.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 book-7" >
                        <img src="/img/School-Books/7.jpg"  class="img-fluid">
                    </div>
                    <div class="col-md-3 pt-4 book-8">
                        <img src="/img/School-Books/8.jpg"  class="img-fluid">
                    </div>
                </div>
            </section>
        </div>
